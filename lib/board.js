...
// Category ids (slugs). Human labels live in public/app.js CATEGORIES.
// To rename/add a category, update this list AND that config together.
const VALID_CATEGORIES = ['birdie_bus', 'booz_allen', 'personal'];
